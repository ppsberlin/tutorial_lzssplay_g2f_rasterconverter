...
* MULTI-THREADED version - many thanks to Phaeron! - /threads parameter
...
* added "cie94" color distance and it is default now for preprocess (much faster than CIEDE2000)
* knoll dithering works in multiple threads
